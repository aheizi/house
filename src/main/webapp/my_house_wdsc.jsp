	...
	<div class="search">
		<div class="lmenu left" >
			<ul id="lmenu_ul">
				...
				<li class="top">
					<a href="myHouse.do?action=wdsc"><img src="images/08.jpg" alt=""></a>
				</li>
				<li class="top">
		...
		<div class="right" id="right-con-user">
			<table class="table table-hover">
			  ...
			  <thead>
			   ...
			   <c:forEach items="${collectHouseOutList}" var="houseOut">
				<tr>
					<td><a href="house.do?action=houseDtail&id=${houseOut.id}" target="_blank">${houseOut.title}</a></td>
				  	...
				  	<td>
				  		<!-- <a href="">编辑</a> -->
						<a href="house.do?action=cancelCollectHouseOut&houseOutId=${houseOut.id}">取消收藏</a>
			  		</td>
				</tr>
			  </c:forEach>
			  <c:if test="${empty collectHouseOutList}">
			...
			<table class="table table-hover">
			  ...
			  <thead>
			   ...
			   <c:forEach items="${collectHouseInList}" var="houseIn">
				<tr>
					<td><a href="houseIn.do?action=houseInDtail&id=${houseIn.id}" target="_blank">${houseIn.title}</a></td>
				  	...
				  	<td>
				  		<!-- <a href="">编辑</a> -->
						<a href="houseIn.do?action=cancelCollectHouseIn&houseInId=${houseIn.id}">取消收藏</a>
			  		</td>
				</tr>
			  </c:forEach>
			  <c:if test="${empty collectHouseInList}">
			  	<tr><td colspan="5" align="center">没有符合条件的记录</td></tr>
			  </c:if>
			</table>
		</div>
